...
public class ObjScatterPdvsId {
	public StringProperty title = new SimpleStringProperty();
	public DoubleProperty Pd = new SimpleDoubleProperty();
	...
	public DoubleProperty PdProperty() {
		return Pd;
	}
	...
	public ObjScatterPdvsId(String titleValue, double PdValue, double UdValue, double UctValue,
