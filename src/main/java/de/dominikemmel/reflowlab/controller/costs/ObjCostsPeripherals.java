...
public class ObjCostsPeripherals {
	...
	public ObjCostsPeripherals(int IDValue, String ComponentNameValue, String ComponentTypeValue, double ComponentCostValue, int RefIDComponentCostValue, String CostUnitValue, String editDateValue) {
		ID.set(IDValue);
